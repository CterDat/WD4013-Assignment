        ...
        <div class="card-body">
            <form action="{{ route('sanpham.update', $sanPham->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" value="{{ $sanPham->so_luong }}" min="1"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" min="1" value="{{ $sanPham->ngay_nhap }}"
                        name="ngay_nhap">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="danh_muc_id">
                        @foreach ($danh_mucs as $item)
                            <option {{ $item->id == $sanPham->danh_muc_id ? 'selected' : '' }} value="{{ $item->id }}">
