                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 product-single-gallery">
                        <div class="product-slider-container">
                            ...
                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                <div class="product-item">
                                    <img class="product-single-image" src="{{ Storage::url($showClothes->image) }}"
                        ...
                        <div class="prod-thumbnail owl-dots">
                            <div class="owl-dot">
                                <img src="{{ asset('images/products/zoom/product-1.jpg') }}" width="110" height="110"
                                    alt="product-thumbnail" />
                            </div>
                            <div class="owl-dot">
                                <img src="{{ asset('images/products/zoom/product-2.jpg') }}" width="110" height="110"
                                    alt="product-thumbnail" />
                            </div>
                            <div class="owl-dot">
                                <img src="{{ asset('images/products/zoom/product-3.jpg') }}" width="110" height="110"
                                    alt="product-thumbnail" />
                            </div>
                            <div class="owl-dot">
                                <img src="{{ asset('images/products/zoom/product-4.jpg') }}" width="110" height="110"
                                    alt="product-thumbnail" />
                            </div>
                    ...
                    <div class="col-lg-7 col-md-6 product-single-details">
                        <h1 class="product-title">{{ $showClothes->name }}</h1>
                        ...
                        <div class="price-box">
                            ...
                            <span class="new-price">${{ $showClothes->price }}</span>
                        </div>
                        <!-- End .price-box -->

                        <div class="product-desc">
                            <p>
                                {{ $showClothes->description }}
                            </p>
                        </div>
                        <!-- End .product-desc -->
                        ...
                        <ul class="single-info-list">
                            ...
                            <li>
                                CATEGORY: <strong><a href="#"
                                        class="product-category">{{ $showClothes->category->name }}</a></strong>
                            </li>
                        ...
                        <div class="product-action">
                            <form action="{{ route('cart.add') }}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{ $showClothes->id }}">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="product-size-content" role="tabpanel"
                        ...
                        <div class="product-size-content">
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="{{ asset('images/products/single/body-shape.png') }}" alt="body shape"
                            ...
                            <div class="comment-list">
                                <div class="comments">
                                    <figure class="img-thumbnail">
                                        <img src="{{ asset('images/blog/author.jpg') }}" alt="author" width="80"
                                            height="80">
                                    </figure>
